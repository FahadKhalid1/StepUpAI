        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li><Link to="/automatisation-ia-paris" className="hover:text-white transition-colors duration-200">{t('footer.service1')}</Link></li>
              <li><Link to="/appels-ia-paris" className="hover:text-white transition-colors duration-200">{t('footer.service2')}</Link></li>
          ...
          <div>
            <h3 className="text-lg font-semibold mb-4">{t('footer.idf_title')}</h3>
            <ul className="space-y-2 text-gray-300">
