              ...
              >
                ...
                <div className="flex items-center gap-4 mt-6">
                  <a
                    ...
                    className="flex items-center gap-2 text-gray-500 hover:text-pink-600 transition-colors duration-300"
                  >
                    ...
                    <span className="text-sm font-medium">@step.upparis</span>
                  </a>
                </div>
              </motion.div>
